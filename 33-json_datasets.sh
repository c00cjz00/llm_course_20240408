...
cp 33-baike.json local/app/python/
cp 33-json_datasets.py local/app/python/
...
bash -c 'export PATH=$PATH:$HOME/.local/bin; HUGGING_FACE_HUB_TOKEN=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 python 33-json_datasets.py'
